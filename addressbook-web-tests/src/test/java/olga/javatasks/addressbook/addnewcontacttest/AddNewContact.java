...
public class AddNewContact {
    ...
    public void AddNewContact() {
        ...
        fillNewContactForm(new NewContactData("John", "Snow", "Winterfell", "none", "jon@snow.com"));
        submitNewContactCreationForm();
        returnToAddressbookPage();
    }

    private void returnToAddressbookPage() {
        wd.findElement(By.linkText("HOME")).click();
    }

    private void submitNewContactCreationForm() {
